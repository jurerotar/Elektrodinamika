...
Gama = 1  # Odbojnost bremena pri z=0
...
line3, = ax.plot(bz, u(az, wt, bz, Gama) *
                 i(az, wt, bz, Gama), '-r')  # Začetni p(t,z)
plt.title(r'Breme $\Gamma=$'+str(Gama) +
          r'     Slabljenje $\alpha/\beta=$'+str(ab))
